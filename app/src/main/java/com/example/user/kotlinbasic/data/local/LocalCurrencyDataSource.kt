...
class LocalCurrencyDataSource @Inject constructor(private  val appDatabase: AppDatabase){

    fun getmAllCurrencies(): Flowable<List<CurrencyEntity>> {
    ...
    fun insertAll(currencyEntityList: List<CurrencyEntity>) {
        appDatabase.currencyDao().insertAll(currencyEntityList)
    }
